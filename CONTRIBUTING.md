...
```bash
uv export --format requirements.txt --group dev --group lint --output-file requirements-dev.txt
```

- as a **QA engineer**?

```bash
uv export --format requirements.txt --group test --group lint --output-file requirements-test.txt
```
