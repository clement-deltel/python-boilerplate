...
Here is a list of all the tools that I use when it comes to code in Python.
...
Here are the tools that could be interesting and further enhance the stack.
...
- [turbovec](https://github.com/RyanCodrai/turbovec) - vector index built on TurboQuant. `Python` `Rust`
...
- [pyodide](https://github.com/pyodide/pyodide) - distribution for the browser and Node.js based on WebAssembly. `Python` `C`
...
Here are the pre-commit hooks that could be interesting and further enhance the stack.
...
- **flake8**
  ...
  - [todos - TD](https://docs.astral.sh/ruff/rules/#flake8-todos-td)
